...
class HistoryManager {
    ...
    generateSettingsSummary(settings) {
        return {
            ...
            motionBlurMode: settings.motionBlurMode || false,
            skinRenderBoost: settings.skinRenderBoost || false,
            hairRenderBoost: settings.hairRenderBoost || false,
            generateFourMode: settings.generateFourMode || false,
            grid3x3Mode: settings.grid3x3Mode || false,
            maxConsistency: settings.maxConsistency || false
        };
    }
